...
const ContactRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    useEffect(() => {
        if (seaTexture) {
            ...
            seaTexture.repeat.set(3, 2);
            seaTexture.anisotropy = 8;
    ...
    const handleMailSelect = () => {
        ...
        window.location.href = 'mailto:showoffbabyy@gmail.com';
    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="LINKEDIN"
                onClick={() => window.open('https://www.linkedin.com/in/saurabhshirbhate', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="GITHUB"
                onClick={() => window.open('https://github.com/SSaurabhShirbhate', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* EMAIL */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="EMAIL"
                onClick={() => window.location.href = 'mailto:showoffbabyy@gmail.com'}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* RESUME */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="RESUME"
                onClick={() => window.open('/resume/saurabh-shirbhate-resume.pdf', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
