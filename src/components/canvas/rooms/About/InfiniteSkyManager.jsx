 ...
 * Education Island (left) and Career Island (right) floating in clouds
 */
...
const BALLOON_CONFIG = [
    ...
    { texture: '/textures/about/threejsduzybalon.webp', paintedTexture: '/textures/about/threejsduzybalon_painted.webp', label: 'Java', size: 'large', x: 2.5, y: 2.5, z: 0.2, phase: 1.5 },
    { texture: '/textures/about/GSAPduzybalon.webp', paintedTexture: '/textures/about/GSAPduzybalon_painted.webp', label: 'Spring Boot', size: 'large', x: 0, y: 3, z: 0.5, phase: 3 },
    ...
    { texture: '/textures/about/nextjssrednibalon.webp', paintedTexture: '/textures/about/nextjssrednibalon_painted.webp', label: 'MySQL', size: 'medium', x: 0, y: 0.5, z: -0.4, phase: 4 },
    ...
    { texture: '/textures/about/figmamalybalon.webp', paintedTexture: '/textures/about/figmamalybalon_painted.webp', label: 'Hibernate', size: 'small', x: -3, y: 4.5, z: -0.5, phase: 3.5 },
