...
const FALLBACK_PROJECTS = [
    {
        ...
        description: 'A Sapiens GhostDraft configurator built in Core Java with MySQL persistence. Insurance products are authored as structured XML/XSD/JSON documents and validated before they ever reach a build — rollout time dropped from weeks to days.',
    ...
    },
    {
        ...
        url: 'https://github.com/SSaurabhShirbhate',
        description: 'Policy technical analyst engagement on the Sapiens GhostDraft configurator. Automated document generation and workflow management across the policy lifecycle, with scrum-driven troubleshooting of configuration defects across P&C product lines.',
        techStack: ['/textures/gallery/jslogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/htmllogo.webp']
    },
    {
        id: 'policypal-ai',
        ...
        url: 'https://github.com/SSaurabhShirbhate',
        description: 'An LLM + RAG assistant for policy documents. Built with Java and Spring Boot over embedded policy PDFs, with a React front-end and strict citations so every answer points at its source page.',
    ...
    },
    {
        ...
        url: 'https://github.com/SSaurabhShirbhate',
        description: 'A microservices expense tracker with AI insights. The monolith was split into ledger, categorisation and insights services built with Spring Boot, MySQL and Dockerised deployments — an AI layer auto-categorises transactions and surfaces spending patterns.',
        techStack: ['/textures/gallery/reactlogo.webp', '/textures/gallery/jslogo.webp', '/textures/gallery/csslogo.webp', '/textures/gallery/netlifylogo.webp']
    },
];
