 ...
 * - SAURABH in Rubik Scribble font (splits into letters during scroll)
 * - Software developer in Cabin Sketch font (also splits)
...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for SAURABH split effect
    const letters = useMemo(() => [
        { char: 'S', baseX: -1.05, splitDir: -1.8, delay: 0 },
        { char: 'A', baseX: -0.7, splitDir: -1.0, delay: 0 },
        { char: 'U', baseX: -0.35, splitDir: -0.4, delay: 0 },
        { char: 'R', baseX: 0.0, splitDir: 0.0, delay: 0 },
        { char: 'A', baseX: 0.35, splitDir: 0.4, delay: 0 },
        { char: 'B', baseX: 0.7, splitDir: 1.0, delay: 0 },
    ...
    const taglineWords = useMemo(() => [
        ...
        { text: 'software', baseX: -0.4, splitDir: -0.8, delay: 0 },
    ...
    useFrame((state, delta) => {
        ...
        // Apply split to each letter of SAURABH
    ...
    return (
        <group ref={groupRef} position={position} scale={[scale, scale, 1]} renderOrder={4}>
            {/* SAURABH Letters - Rubik Scribble font with fade-in animation */}
