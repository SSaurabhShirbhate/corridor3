...
import {
    SEGMENT_LENGTH as DEFAULT_SEGMENT_LENGTH,
    START_Z,
    DOOR_OFFSETS
} from '../config/corridorConfig';

// Door positions for auto-glance (segment-relative)
const DOOR_POSITIONS = DOOR_OFFSETS.map(d => ({ z: d.relativeZ, side: d.side }));
