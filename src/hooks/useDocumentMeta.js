...
const ROOM_META = {
    null: {
        path: '/',
        title: 'Saurabh Shirbhate — Software Developer Portfolio',
        description: 'Interactive 3D developer portfolio by Saurabh Shirbhate. Explore Java, Spring Boot and React projects in a hand-drawn gallery.',
    },
    about: {
        path: '/about',
        title: 'About Me — Saurabh Shirbhate Portfolio',
        description: 'Learn about Saurabh Shirbhate — a full-stack Java developer building insurance-domain systems at Sapiens, specializing in Spring Boot, React, and XML/XSD/XSLT.',
    },
    gallery: {
        path: '/gallery',
        title: 'Gallery & Projects — Saurabh Shirbhate Portfolio',
        description: 'Browse the interactive 3D gallery of software development projects by Saurabh Shirbhate. Each project is displayed as a hand-drawn card you can flip and explore.',
    },
    studio: {
        path: '/studio',
        title: 'The Studio — Saurabh Shirbhate Portfolio',
        description: 'Explore Saurabh Shirbhate\'s content studio — videos, posts, and articles displayed on floating monitors in an immersive 3D space.',
    },
    contact: {
        path: '/contact',
        title: 'Contact — Saurabh Shirbhate Portfolio',
        description: 'Get in touch with Saurabh Shirbhate. Find social media links and contact information in this interactive 3D contact room.',
    },
};
...
export function useDocumentMeta() {
    ...
    useEffect(() => {
        ...
        if (ogUrl) ogUrl.setAttribute('content', `https://saurabh-portfolio.pages.dev${meta.path}`);

        // Update canonical link to ensure virtual routes are correctly indexable as separate pages
        const canonicalTag = document.querySelector('link[rel="canonical"]');
        if (canonicalTag) {
            canonicalTag.setAttribute('href', `https://saurabh-portfolio.pages.dev${meta.path}`);
        }
